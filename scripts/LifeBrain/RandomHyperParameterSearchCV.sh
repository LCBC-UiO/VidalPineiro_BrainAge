...
#SBATCH --account=p274
#SBATCH --output scripts/LifeBrain/logs_RandomHyperParameterSearchCV/slurm-%j.txt
...
mv scripts/LifeBrain/logs_RandomHyperParameterSearchCV/slurm-${SLURM_JOBID}.txt scripts/LifeBrain/logs_RandomHyperParameterSearchCV/slurm.it.$i.txt
