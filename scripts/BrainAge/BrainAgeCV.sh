...
#SBATCH --account=p274
#SBATCH --output scripts/BrainAge/logs_BrainAgeCV/slurm-%j.txt
...
mv scripts/BrainAge/logs_BrainAgeCV/slurm-${SLURM_JOBID}.txt scripts/BrainAge/logs_BrainAgeCV/slurm.it.$i.txt
